		...
		loop: for (;;) {
			switch (state) {
				...
				case 27:
					...
					else if (ch == 'n') {AddCh(); state = 34; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 28:
					recEnd = pos; recKind = 2;
				...
				case 35:
					...
					else if (ch == 'c') {AddCh(); state = 38; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 36:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 't') {AddCh(); state = 39; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 37:
					recEnd = pos; recKind = 2;
				...
				case 38:
					...
					else if (ch == 'r') {AddCh(); state = 41; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 39:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); state = 2; break;}
				...
				case 40:
					...
					else if (ch == 'i') {AddCh(); state = 43; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 41:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'e') {AddCh(); state = 44; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 42:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'o') {AddCh(); state = 45; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 43:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'r') {AddCh(); state = 46; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 44:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'u' || ch >= 'w' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'v') {AddCh(); state = 47; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 45:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'b' || ch >= 'd' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'c') {AddCh(); state = 48; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 46:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'o') {AddCh(); state = 49; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 47:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'b' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'a') {AddCh(); state = 50; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 48:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'b' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'a') {AddCh(); state = 51; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 49:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
