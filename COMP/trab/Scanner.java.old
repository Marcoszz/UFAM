...
public class Scanner {
	...
	static {
		...
		for (int i = 97; i <= 100; ++i) start.set(i, 2);
		for (int i = 102; i <= 104; ++i) start.set(i, 2);
		for (int i = 106; i <= 110; ++i) start.set(i, 2);
		for (int i = 112; i <= 122; ++i) start.set(i, 2);
		start.set(34, 3); 
		start.set(40, 5); 
		start.set(58, 6); 
		start.set(44, 7); 
		...
		literals.put("variavel", new Integer(15));
		literals.put("inteiro", new Integer(16));
		literals.put("novo", new Integer(20));
		literals.put("retorne", new Integer(23));
		literals.put("caso", new Integer(25));
		literals.put("seja", new Integer(26));
		literals.put("faca", new Integer(27));
		literals.put("fimcaso", new Integer(29));
		literals.put("se", new Integer(30));
		literals.put("entao", new Integer(31));
		literals.put("senao", new Integer(32));
		literals.put("fimse", new Integer(33));
		literals.put("enquanto", new Integer(34));
		literals.put("fimenquanto", new Integer(35));
		literals.put("para", new Integer(36));
		literals.put("ate", new Integer(37));
		literals.put("passo", new Integer(38));
		literals.put("fimpara", new Integer(39));
		literals.put("repita", new Integer(40));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 27:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'n') {AddCh(); state = 32; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 28:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 's') {AddCh(); state = 33; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 29:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 't' || ch >= 'v' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'u') {AddCh(); state = 34; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 30:
				...
				case 32:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 't') {AddCh(); state = 35; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 33:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'b' || ch >= 'd' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'c') {AddCh(); state = 36; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 34:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 't') {AddCh(); state = 37; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 35:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'e') {AddCh(); state = 38; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 36:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'r') {AddCh(); state = 39; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 37:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'r') {AddCh(); state = 40; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 38:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'h' || ch >= 'j' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'i') {AddCh(); state = 41; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 39:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'e') {AddCh(); state = 42; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 40:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'o') {AddCh(); state = 43; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 41:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'q' || ch >= 's' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'r') {AddCh(); state = 44; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 42:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'u' || ch >= 'w' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'v') {AddCh(); state = 45; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 43:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'b' || ch >= 'd' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'c') {AddCh(); state = 46; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 44:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 2; break;}
				...
				case 45:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'b' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'a') {AddCh(); state = 48; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 46:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'b' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'a') {AddCh(); state = 49; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 47:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
				...
				case 48:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == '(') {AddCh(); state = 16; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 49:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 2; break;}
				...
				case 50:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 2; break;}
					else if (ch == 'o') {AddCh(); state = 51; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 51:
					recEnd = pos; recKind = 2;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
