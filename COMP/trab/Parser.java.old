...
public class Parser {
	...
	void Uportugol() {
		...
		while (la.kind == 7 || la.kind == 12 || la.kind == 15) {
			if (la.kind == 7) {
				FunDecl();
			} else if (la.kind == 15) {
				VarDecl();
	...
	void ConstDecl() {
		String constDleca = "";
		Expect(12);
		constDleca = html.formatReserved("constante"); constDleca +=" "; 
		Expect(2);
		constDleca += html.formatFuncName(t.val); constDleca +=" "; 
		Expect(13);
	...
	private static final boolean[][] set = {
		...
		{x,x,T,x, x,x,x,x, x,x,x,x, T,x,x,T, x,x,x,x, x,x,x,T, T,T,x,x, x,x,T,x, x,x,T,x, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,x,x, x,x,T,x, x,x,T,x, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, T,T,T,x, x}
