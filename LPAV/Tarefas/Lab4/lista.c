    ...
    if(!auxiliar){
        ...
        if(evento->temp < auxiliar->evento->temp){
            ...
            *lista = item_novo;
            ...
            while(auxiliar->prox != NULL && (auxiliar->prox->evento->temp < evento->temp || (auxiliar->prox->evento->temp == evento->temp && auxiliar->prox->evento->alvo < evento->alvo))) auxiliar = auxiliar->prox;
            item_novo->evento = evento;
